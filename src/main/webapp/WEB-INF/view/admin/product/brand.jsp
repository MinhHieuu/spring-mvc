    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form:form action="/admin/brand/create" method="post" modelAttribute="newBrand">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        document.getElementById("brandId").value = "${editBrand.id}";
        document.getElementById("brandName").value = "${editBrand.name}";
        const modal = new bootstrap.Modal(document.getElementById("modalUpdate"));
        modal.show();
        </c:if>
    });
